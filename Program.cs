...
namespace ZadaniaDljaKollegi
{
 ...
 ok next assignment. print numbers from 10 to 20. you can modify the loop I wrote or white a new one. 
 assignment 3. print numbers from 10 to 20 in step of 2. (10,12,14,16...)
 assignment 4. print numbers from 10 to 1 in descending order (10,9,8,7...)
 assignment 5. create an array of 10 elements of type integer. fill the array with numbers from 0 to 9. print all elements of the array (2 loops)
